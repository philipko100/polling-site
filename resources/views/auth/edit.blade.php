...
<div class="container">
    ...
    <p>
        ...
        Religion: <input class="form-control" type="text" name="religion" value="{{Auth::user()->religion}}"><br>
        <br>
        ...
        Current Country: <div>
                <select id="current_country" name="current_country" class="custom-select form-control {{ $errors->has('current_country') ? ' is-invalid' : '' }}" name="current_country" value="{{ old('current_country') }}" required autofocus> 
                    <option value="{{Auth::user()->current_country}}" selected>{{Auth::user()->current_country}}</option> 
        ...
        Hometown City: <input class="form-control" type="text" name="hometown_city" value="{{Auth::user()->hometown_city}}"><br>
        Hometown Province or State: <input class="form-control" type="text" name="hometown_province" value="{{Auth::user()->hometown_province}}"><br>
        Hometown Country: <div>
            <select id="hometown_country" name="hometown_country" class="custom-select form-control {{ $errors->has('hometown_country') ? ' is-invalid' : '' }}" name="hometown_country" value="{{ old('hometown_country') }}" required autofocus> 
                <option value="{{Auth::user()->hometown_country}}" selected>{{Auth::user()->hometown_country}}</option> 
                <option value="Canada">Canada</option>
                <option value="United States of America">United States of America</option>
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
            ...
            @if ($errors->has('hometown_country'))
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('hometown_country') }}</strong>
                </span>
            @endif
        </div>
    </p>
